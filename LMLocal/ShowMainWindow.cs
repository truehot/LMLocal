...
namespace LMLocal
{
    ...
    internal sealed class ShowMainWindow
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ShowMainWindow"/> class.
        /// Adds our command handlers for menu (commands must exist in the command table file)
        /// </summary>
        /// <param name="package">Owner package, not null.</param>
        /// <param name="commandService">Command service to add command to, not null.</param>
        private ShowMainWindow(AsyncPackage package, OleMenuCommandService commandService)
        {
        ...
        /// </summary>
        public static ShowMainWindow Instance
        {
            get;
            private set;
        }
        ...
        {
            // Switch to the main thread - the call to AddCommand in ShowMainWindow's constructor requires
            // the UI thread.
            await ThreadHelper.JoinableTaskFactory.SwitchToMainThreadAsync(package.DisposalToken);

            OleMenuCommandService commandService = await package.GetServiceAsync(typeof(IMenuCommandService)) as OleMenuCommandService;
            Instance = new ShowMainWindow(package, commandService);
        }
